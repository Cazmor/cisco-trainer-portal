...
function loadDeliveryTab(content) {
    ...
    var html = '<div class="card"><div class="card-header"><h3><i class="fas fa-book"></i> Cisco Curriculum Delivery Plan</h3></div><div style="text-align:center;padding:20px;background:#f8fafc;border-radius:12px;margin-bottom:20px"><div style="font-size:40px;font-weight:700;color:#8b5cf6">'+overall+'%</div><div>Overall | '+doneH+'/'+totalH+' hrs</div></div><div style="margin-bottom:12px"><strong>Stream:</strong> <select id="deliveryFilter" class="form-control" style="width:180px;display:inline;margin-left:8px" onchange="renderDeliveryDetail()"><option value="all">All Streams</option>';
